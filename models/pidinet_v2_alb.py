...
class PPDM(nn.Module):
    ...
    def forward(self, x):
        x = (self.init_block_ad(x) + self.init_block_cd(x)
             + self.init_block_cv(x)) / 3
...
class PDCBlock(nn.Module):
    def __init__(self, inplane, ouplane, stride=1, bias=False, act=None, full=False):
    ...
    def forward(self, x):
        ...
        if self.full:
            ...
            y = (self.conv_cv(x) + self.conv_cd(x) + self.conv_ad(x)) / 3
...
class PiDiNetv2(nn.Module):
    def __init__(self, inplane, dil=None, sa=False, convert=False, act=None):
        ...
        self.block1_2 = block_class(self.inplane, self.inplane, act=act, full=True)
        ...
        self.block2_3 = block_class(self.inplane, self.inplane, act=act, full=True)
        ...
        self.block3_3 = block_class(self.inplane, self.inplane, act=act, full=True)
        ...
        self.block4_3 = block_class(self.inplane, self.inplane, act=act, full=True)
